...
svm_pipeline = Pipeline([
    ...
    ('svm', SVC(kernel='linear', probability=True))  # Use a linear SVM
])
...
val_predictions = svm_pipeline.predict(val_texts)
...
test_predictions = svm_pipeline.predict(test_texts)
...
predictions_df.to_csv('/content/drive/My Drive/TYP/SVM/svm_predictions.csv', index=False)

print("\nPer-sample predictions saved to /content/drive/My Drive/TYP/SVM/svm_predictions.csv")
...
output_file_path = '/content/drive/My Drive/TYP/SVM/svm_evaluation.txt'
